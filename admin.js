...
content.addEventListener('submit', async (event) => {
  ...
  button.disabled = true;
  try {
    const agentName = event.target.querySelector('select[name="agentName"]')?.value || 'Fitri';
