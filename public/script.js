  ...
  return {
    ...
    benefits: isDevApi
      ? [
          ...
          'Satu API Key untuk semua model â€” endpoint kompatibel 100% dengan OpenAI SDK.',
          'Kurs tetap Rp12.300/$1 â€” tidak ada biaya berlangganan bulanan.',
    ...
    terms: isDevApi
      ? [
          ...
          'Aktivasi API Key diproses admin dalam 1â€“3 jam di jam aktif (08.00â€“21.00 WIB).',
...
function localBotAnswer(question) {
  ...
  if (text.includes('bayar') || text.includes('qris')) return 'Pembayaran menggunakan QRIS. Setelah checkout, sistem membuat QR sesuai nominal total belanja termasuk biaya admin Rp99. Scan QR tersebut lalu tekan â€œPembayaran sudah selesaiâ€.';
  ...
  return 'Saya belum memahami pertanyaan itu. Coba tulis nama produk, â€œcek stokâ€, â€œcara pesanâ€, â€œgaransiâ€, â€œGmail sendiriâ€, â€œpengirimanâ€, atau pilih Chat Admin.';
}
